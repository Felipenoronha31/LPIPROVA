...
<?php
    ...
    $sql="select * from veiculo where placa_veiculo='{$id}'";
    ...
    <form method="POST" enctype="multipart/form-data">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        <td>
                            Nome:
                            <input type="text" name="nome" value="<?php echo $result['nome_veiculo']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Marca:
                            <input type="text" name="marca" value="<?php echo $result['marca_veiculo']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Ano:
                            <input type="text" name="ano" value="<?php echo $result['ano_veiculo']?>">
                        </td>
                    </tr>
                    <tr>
